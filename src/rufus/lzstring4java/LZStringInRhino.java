...
public class LZStringInRhino {
	...
	protected static StringBuffer getStringFromJSFile(File file, String encoding) throws IOException {
		// file.length() is in bytes count, char counts can be smaller.
		// anyway, ensure the capacity. bigger is ok.
		StringBuffer sb = new StringBuffer((int) file.length());
	...
	protected static void writeStringToFile(File file, String str, String strencoding) throws IOException {
	...
	protected static String LZ_STRING_JS_FILE_PATH = "C:\\EcliWork\\LZString4Java\\tester\\lz-string-1.3.3-min.js";
